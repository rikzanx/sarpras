...
@section('judul')
List Transaksi Barang Keluar | Sarpras Depkam
@endsection
...
<div class="modal fade" id="modaltambah" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form action="{{ route('isms_add_transaksi_barang_keluar_action') }}" method="post">
                @csrf
...
<div class="modal fade" id="modaledit" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form action="{{ route('isms_edit_transaksi_barang_keluar_action',':id') }}" method="post">
                @csrf
                <div class="modal-header">
...
<div class="modal fade" id="modaldelete" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xxs" role="document">
        <div class="modal-content">
            <form action="{{  route('isms_delete_transaksi_barang_keluar_action',':id') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-header">
...
<script>
    ...
    function modalshow(id) {
        $.ajax({
            url: `{{ route('isms_show_transaksi_barang', ':id') }}`.replace(':id', id),
            method: 'GET',
