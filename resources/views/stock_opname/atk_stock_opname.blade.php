...
@section('judul')
Stock Opname Barang ATK | Sarpras Depkam
@endsection
        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card px-4">
                <div class="card-header mt-4 py-2 px-1 d-flex justify-content-between align-items-center">
                    <h4>Stock Opname Barang ATK</h4>
                    <a href="{{ route('atk_stock_opname_tambah') }}" class="btn btn-primary text-white">+ Add Stock Opname</a>
                </div>
